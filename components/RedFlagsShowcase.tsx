...
const BILLING_FLAGS: RedFlag[] = [
    {
        ...
        description: "Identical service billed twice on the same statement.",
    ...
    {
        id: "RF002",
        title: "Facility Fee on Outpatient",
        description: "Facility fee charged for outpatient visit (treated and released same day).",
        detectionMethod: "Checks for 'Facility Fee' + 'ER' + 'Treated and Released' keywords.",
        severity: "HIGH",
        confidence: 97,
    ...
    {
        id: "RF003",
        title: "Out-of-Network Marked",
        description: "Service provider flagged as out-of-network without documented consent.",
        detectionMethod: "Scans line items for explicit 'Out-of-Network' or 'Non-Par' labels.",
        severity: "HIGH",
        confidence: 99,
    ...
    {
        id: "RF004",
        title: "Duplicate Facility Fees",
        description: "Two separate facility-related charges with identical names.",
        detectionMethod: "Identifies duplicate facility line items on the same bill.",
        severity: "HIGH",
        confidence: 92,
    ...
    {
        id: "RF005",
        title: "Obvious Unbundling",
        description: "Routine supplies (gloves, gauze) billed separately from procedure.",
        detectionMethod: "Matches routine supply charges to corresponding procedure codes.",
        severity: "MEDIUM",
        confidence: 90,
    ...
    {
        id: "RF006",
        title: "Severe Upcoding",
        description: "High-complexity level charged for likely simple treatment.",
        detectionMethod: "Compares ER Level 4-5 codes against simple visit descriptions.",
        severity: "MEDIUM",
        confidence: 85,
    ...
    },
    {
        ...
        description: "Possible upcoding by 1 complexity level (e.g. Level 3 vs 2).",
        detectionMethod: "Detects minor complexity level discrepancies for review.",
        severity: "INFO",
        confidence: 75,
