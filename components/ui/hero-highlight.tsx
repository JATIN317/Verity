...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex min-h-[40rem] w-full items-center justify-center overflow-hidden bg-background",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-primary/40 to-primary/60 px-1 pb-1`,
        className,
      )}
    >
      {children}
